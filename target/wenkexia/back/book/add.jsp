...
<hr />
<div align="center">
	<form action="${path}/book/insert" method="post" enctype="multipart/form-data">
		<table>
			<tr>
				<td>名称：</td>
				<td><input type="text" name="bookName" class="el-input__inner"></td>
				<td rowspan="14" style="width: 300px">
				<td>页数：</td>
				<td><input type="number" name="pageNum" class="el-input__inner"></td>
			</tr>
			...
			<tr>
				...
				<td>
					<select name="cateId" class="el-select__inner inner2">
						<c:forEach items="${requestScope.categorys}" var="a">
							<option value="${a.id}">${a.cateName}</option>
						</c:forEach>
					</select>
				</td>
				<td>字数：</td>
				<td><input type="number" name="publicCount" class="el-input__inner"></td>
			</tr>
			...
			<tr>
				<td>当当价：</td>
				<td><input type=number name="ddPrice" class="el-input__inner"></td>
				<td></td>
			</tr>
			<tr>
				<td>库存：</td>
			...
			<tr>
				...
				<td>编辑推荐：</td>
				<td rowspan="2"><textarea class="el-textarea__inner" name="recommend"></textarea></td>
			</tr>
			<tr>
				<td>出版社：</td>
				<td><input type="text" name="company" class="el-input__inner"></td>
				<td></td>
			</tr>
			<tr>
				<td>出版时间：</td>
				<td><input type="date" name="publishTime" class="el-input__inner"></td>
				<td>内容简介：</td>
				<td rowspan="2"><textarea class="el-textarea__inner" name="contentAbstract"></textarea></td>
			</tr>
			<tr>
				<td>版次：</td>
			...
			<tr>
				<td>印刷时间：</td>
				<td><input type="date" name="printTime" class="el-input__inner"></td>
				<td>作者简介：</td>
				<td rowspan="2"><textarea class="el-textarea__inner" name="authorAbstract"></textarea></td>
			</tr>
			<tr>
				<td>印次：</td>
			...
			<tr>
				...
				<td>媒体评论：</td>
				<td rowspan="2"><textarea class="el-textarea__inner" name="mediaCommentary"></textarea></td>
			</tr>
			<tr>
				<td>包装：</td>
